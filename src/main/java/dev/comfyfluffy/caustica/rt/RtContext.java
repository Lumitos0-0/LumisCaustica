...
public final class RtContext {
    ...
    /**
     * Create a 3D storage image (VK_IMAGE_TYPE_3D) of the given format, transitioned to GENERAL. Used for
     * the frustum-aligned froxel volumetric grid, whose third axis is depth slices rather than array
     * layers. Same usage/feature requirements and ownership as {@link #createStorageImage}.
     */
