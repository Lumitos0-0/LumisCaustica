...
public final class RtContext {
    ...
    /** Create a 3D storage image (STORAGE + SAMPLED + TRANSFER_SRC/DST), transitioned to GENERAL. */
    public RtImage3D createStorageImage3D(int width, int height, int depth, int format, String label) {
        int usage = VK10.VK_IMAGE_USAGE_STORAGE_BIT | VK10.VK_IMAGE_USAGE_SAMPLED_BIT
        ...
        return new RtImage3D(vma, vk, image, allocation, view, width, height, depth);
    }
