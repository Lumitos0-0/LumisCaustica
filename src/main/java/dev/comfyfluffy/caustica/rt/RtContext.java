...
public final class RtContext {
    ...
    /**
     * A three-dimensional storage image, for the aerial medium's light volume. Same usage and layout as
     * {@link #createStorageImage(int, int, int, String)}; the returned {@link RtImage} reports the extent's
     * width and height, since only the view handle is consumed after creation.
     */
