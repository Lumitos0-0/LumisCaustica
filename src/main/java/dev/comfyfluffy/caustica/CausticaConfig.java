...
public final class CausticaConfig {
    ...
    private static void writeComments() {
        ...
        FILE.setComment("volumetrics",
                " Camera-frustum froxel fog. quality: 0 performance, 1 balanced, 2 high, 3 ultra, 4 ultra+, 5 cinematic.\n"
    ...
    public static final class Rt {
        ...
        public static final class Volumetrics {
            ...
            // 0 performance, 1 balanced, 2 high, 3 ultra, 4 ultra+, 5 cinematic. GRID_PIXEL_SIZE and
            // DEPTH_SLICES define the balanced baseline; the quality preset scales both, preserving
            // advanced TOML tuning.
            public static final IntSetting QUALITY =
                    clampedInt("caustica.rt.froxelQuality", "volumetrics.quality", 1, 0, 5);
