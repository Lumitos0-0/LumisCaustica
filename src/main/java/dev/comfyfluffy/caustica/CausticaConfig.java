...
public final class CausticaConfig {
    ...
    private static void writeComments() {
        ...
        FILE.setComment("fog",
                " Primary-view hybrid volumetric fog. Direct sun/moon shafts use TLAS visibility; GI is a soft temporal field.\n"
                        + " The fog volume is integrated before DLSS Ray Reconstruction. Density is in inverse blocks.");
    ...
    public static final class Rt {
        ...
        /**
         * Primary-view hybrid volumetric fog. The direct and GI fields share the camera-relative froxel
         * domain but keep separate filtering: directional light shafts stay sharp while the one-bounce
         * radiance-cache field accumulates softly over time.
         */
